...
document.addEventListener('visibilitychange',
    function () {
        if (document.visibilityState === "visible") {
            document.title = "Portfolio | Kavishka";
...
console.log(projects);
        ...
        <div class="image-overlay" >
            ...
            <div class="content">
                ...
                <div class="desc">
                    <p>${project.desc}</p>
                    <div class="btns">
                        <a href="#" class="btn view-btn" data-images='${JSON.stringify(images)}'><i class="fas fa-eye"></i> View</a>
                        <a href="${project.links.code}" class="btn" target="_blank">Code <i class="fas fa-code"></i></a>
                    </div>
                </div>
            </div>
    ...
    let modalSlides = document.querySelector(".modal-content .slides");
    ...
    function showSlides(n) {
        let slides = modalSlides.querySelectorAll('img');
...
//     reset: true
// });
// srleft.reveal('.about .image', { delay: 400 });
